...
| Any finding `severity = high` | `gh pr review <num> --request-changes --body "<findings>"` then `gh issue create --title "[claude-review] PR #<num>: <one-line summary>" --body "<findings>" --label claude-review` |
